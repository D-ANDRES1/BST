...
public class ArbolBinarioBusqueda {
    ...
    private int contarNodosRec(Nodo nodo) {
        ...
        return 1 +
            contarNodosRec(nodo.izquierdo) +
            contarNodosRec(nodo.derecho);
    }
    ...
    private boolean esBalanceadoRecu(Nodo nodo) {
        ...
        int diff = Math.abs(izq - der);

        
        
        return diff <= 1 &&
               esBalanceadoRecu(nodo.izquierdo) &&
               esBalanceadoRecu(nodo.derecho);
    }
    ...
    private Nodo lcaRecursivo(Nodo nodo, int vi1, int v2) {
