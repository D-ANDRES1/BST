...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1. Contar nodos: " + arbol.contarNodos());
        System.out.println("2. Es BST valido: " + arbol.esBSTValido());
        System.out.println("3. Es balanceado: " + arbol.esBalanceado());

        Nodo lca = arbol.lca(10, 80);
        System.out.println("4. LCA (10, 80): " + (lca != null ? lca.dato : "null"));

        System.out.println("5. Invertir arbol");
        arbol.invertir();
